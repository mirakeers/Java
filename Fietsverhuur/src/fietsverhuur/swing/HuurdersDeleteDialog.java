 ...
 * @author Myra
 */
public class HuurdersDeleteDialog extends javax.swing.JDialog {
    ...
    public HuurdersDeleteDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HuurdersDeleteDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HuurdersDeleteDialog dialog = new HuurdersDeleteDialog(new javax.swing.JFrame(), true);
