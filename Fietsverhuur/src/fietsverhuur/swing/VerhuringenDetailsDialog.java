 ...
 * @author Myra
 */
public class VerhuringenDetailsDialog extends javax.swing.JDialog {

    /**
     * Creates new form VerhuringenEditDialog2
     */
    
    public VerhuringenDetailsDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerhuringenDetailsDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VerhuringenDetailsDialog dialog = new VerhuringenDetailsDialog(new javax.swing.JFrame(), true);
